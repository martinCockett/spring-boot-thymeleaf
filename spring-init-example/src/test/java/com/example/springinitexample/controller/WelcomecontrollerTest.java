package com.example.springinitexample.controller;


import com.example.springinitexample.controller.WelcomeController;
...
public class WelcomecontrollerTest {
    ...
    public void welcome() throws Exception {
        ResultActions resultActions = mockMvc.perform(get("/"))
                ...
                .andExpect(model().attribute("message", equalTo("Martin")))
                .andExpect(model().attribute("tasks", is(expectedList)))
                .andExpect(content().string(containsString("Hello, Martin")));
